...
def generate_content(entry):
    ...
    try:
        ...
        - **サポートのお願いの直後に、今回のニュース内容やAIに関連するハッシュタグを必ず10個以上考えて出力してください（例: #AI #最新テクノロジー #Gemini など）。**
        - **【最重要】出力が途中で途切れないよう、必ず挨拶からオチ、サポートのお願い、ハッシュタグまで完全に記述しきって、記事を完結させてください。**

        【出力形式】
        各発言を "【キャラクター名】: 発言内容" の形式で書き、最後にハッシュタグをまとめて記載してください。
        """
